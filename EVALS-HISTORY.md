# EVALS-HISTORY — the closed iteration log, moved verbatim

Append-only companion to [EVALS.md](EVALS.md), per the compaction
runbook (docs/evals-compaction-runbook.md): closed iterations,
completed experiments, and finished build notes are MOVED here
verbatim — never rewritten — when they leave the working file. This
file and the archive snapshots (docs/evals-archive/) are never fed to
models; the working file is. Full pre-split snapshot:
docs/evals-archive/EVALS-2026-08-16-429e11b.md.
