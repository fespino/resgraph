...
- src/resgraph/evals/ — the analyst's eval harness (D24): deterministic graders, pinned judge, store-isolated runner, report, judge spend breaker (D29a); datasets + runs live in evals/
