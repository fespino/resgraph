...
comes from the generator's parameter space, not from fresh paint. And the scenarios are generated by
...
disclosed version of a real alternative — but a synthesized task's ground
